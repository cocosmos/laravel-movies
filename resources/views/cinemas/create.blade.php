<x-app>
    ...
    <form method="POST" action="{{route('cinema.store')}}" enctype="multipart/form-data">
        ...
        <p>
            ...
            <input type="text" name="address" id="address" value="" max="2022" min="1900" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm">
        </p>
        <p>
